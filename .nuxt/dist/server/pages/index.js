...
module.exports.__inject__ = function (context) {
  add("339c4075", content, true, context)
};
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "footer{color:var(--textColor);padding:.4em .8em}@media(min-width:40em){footer{align-items:center;display:flex;flex-wrap:wrap;justify-content:space-between}}footer p{text-align:left;margin:0}footer p a{color:var(--siteBlue);font-weight:900;text-decoration:none}footer p a:hover{color:var(--siteRed)}@media(min-width:40em){footer .social{display:flex}}footer .social svg{fill:var(--siteBlue);margin:.6em 1em 0 0;transition:fill .2s;width:2rem}footer .social svg:hover{fill:var(--siteRed)}footer .social svg:hover .liquid{fill:#fd0}footer .social .cafe-tooltip:hover rect{fill:#fff}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ":root{--bgLighter:#fffaf4;--borderColor:#212832;--bgColor:#fff6ec;--siteRed:#ff5463;--siteOrange:#ff9365;--siteYellow:#fbd887;--siteLightblue:#84c9d2;--siteBlue:#6ebfb5;--siteGreen:#9ee6cf;--textColor:#0e1a27;--borderColor:#222831;--stripedColor:hsla(0,0%,100%,0.7)}html{font-family:\"Montserrat\",\"Helvetica Neue\",Arial,sans-serif;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased}*,:after,:before{box-sizing:border-box}.top{background-color:#ff5463;background-color:var(--siteRed);border-bottom:1px solid #222831;border-bottom:1px solid var(--borderColor);height:.5rem;width:100%}.loaders-page .top{background-color:#84c9d2;background-color:var(--siteLightblue)}body{background-color:#fff6ec;background-color:var(--bgColor);background-image:linear-gradient(0deg,transparent 24%,hsla(0,0%,100%,.7) 25%,hsla(0,0%,100%,.7) 26%,transparent 27%,transparent 74%,hsla(0,0%,100%,.7) 75%,hsla(0,0%,100%,.7) 76%,transparent 77%,transparent),linear-gradient(90deg,transparent 24%,hsla(0,0%,100%,.7) 25%,hsla(0,0%,100%,.7) 26%,transparent 27%,transparent 74%,hsla(0,0%,100%,.7) 75%,hsla(0,0%,100%,.7) 76%,transparent 77%,transparent);background-image:linear-gradient(0deg,transparent 24%,var(--stripedColor) 25%,var(--stripedColor) 26%,transparent 27%,transparent 74%,var(--stripedColor) 75%,var(--stripedColor) 76%,transparent 77%,transparent),linear-gradient(90deg,transparent 24%,var(--stripedColor) 25%,var(--stripedColor) 26%,transparent 27%,transparent 74%,var(--stripedColor) 75%,var(--stripedColor) 76%,transparent 77%,transparent);background-size:40px 40px;color:#0e1a27;color:var(--textColor);height:100%;margin:0;text-align:center}body.loaders-page{--bgLighter:#1e2d40;--bgColor:#0e1a27;--textColor:#fff6ec;--stripedColor:#222831;--borderColor:#1e2d40}.main-wrapper{display:grid;grid-template-rows:auto 1fr auto;min-height:100vh}h1{font-weight:900;letter-spacing:.05em;margin:3rem 0 0;text-transform:uppercase}a{transition:all .2s}.highlight{color:#ff5463;color:var(--siteRed)}.home-link{display:block;font-size:1rem}.home-link a{color:#ff9365;color:var(--siteOrange);transition:color .2s;text-decoration:none}.home-link a:hover{color:#ff5463;color:var(--siteRed)}h2{font-size:1.2rem;font-weight:400}h2 a{color:#6ebfb5;color:var(--siteBlue)}h2 a:hover{color:#ff9365;color:var(--siteOrange);text-decoration:none}.icons-container{grid-gap:.5em;gap:.5em;justify-content:space-between;margin:1em auto 5em;max-width:1200px;grid-auto-flow:row dense}@media(min-width:20em){.icons-container{display:grid;grid-template-columns:repeat(2,1fr)}}@media(min-width:40em){.icons-container{grid-template-columns:repeat(3,1fr)}}@media(min-width:50em){.icons-container{grid-template-columns:repeat(4,1fr)}}@media(min-width:60em){.icons-container{grid-template-columns:repeat(5,1fr);grid-template-columns:repeat(6,1fr)}}.icons-container .single-icon{background-color:#fff6ec;background-color:var(--bgColor);border:1px solid #222831;border:1px solid var(--borderColor);display:grid;padding-top:.8em;position:relative;transition:all .2s}.icons-container .single-icon:nth-child(17n){grid-row:span 2}.icons-container .single-icon:nth-child(7n){grid-column:span 2}.icons-container .single-icon.active,.icons-container .single-icon:focus,.icons-container .single-icon:hover,.icons-container .single-icon[focus-within]{background-color:#fffaf4;background-color:var(--bgLighter)}.icons-container .single-icon.active,.icons-container .single-icon:focus,.icons-container .single-icon:focus-within,.icons-container .single-icon:hover{background-color:#fffaf4;background-color:var(--bgLighter)}.icons-container .single-icon.active .btn,.icons-container .single-icon:focus .btn,.icons-container .single-icon:hover .btn,.icons-container .single-icon[focus-within] .btn{opacity:1;visibility:visible}.icons-container .single-icon.active .btn,.icons-container .single-icon:focus-within .btn,.icons-container .single-icon:focus .btn,.icons-container .single-icon:hover .btn{opacity:1;visibility:visible}.icons-container .single-icon.active p,.icons-container .single-icon:focus p,.icons-container .single-icon:hover p,.icons-container .single-icon[focus-within] p{background-color:#9ee6cf;background-color:var(--siteGreen)}.icons-container .single-icon.active p,.icons-container .single-icon:focus-within p,.icons-container .single-icon:focus p,.icons-container .single-icon:hover p{background-color:#9ee6cf;background-color:var(--siteGreen)}.icons-container .single-icon.active svg,.icons-container .single-icon:focus svg,.icons-container .single-icon:hover svg,.icons-container .single-icon[focus-within] svg{margin:.5em auto}.icons-container .single-icon.active svg,.icons-container .single-icon:focus-within svg,.icons-container .single-icon:focus svg,.icons-container .single-icon:hover svg{margin:.5em auto}.icons-container .single-icon form{display:inherit}.icons-container .single-icon p{border-top:1px solid #222831;border-top:1px solid var(--borderColor);margin:0;padding:.4em;text-transform:lowercase;display:flex;align-items:center;justify-content:center}.icons-container .single-icon svg{height:60px;margin:2em auto -1em;transition:margin .2s;width:60px}.icons-container .single-icon svg.with-bg{background-image:radial-gradient(rgba(110,191,181,.4) 18%,transparent 0);background-size:140px 140px;background-position:-45px -40px}.icons-container .single-icon .btn{background-color:#fff6ec;background-color:var(--bgColor);border:0;border-top:1px solid #222831;border-top:1px solid var(--borderColor);cursor:pointer;font-family:\"Montserrat\";font-size:1rem;font-weight:500;opacity:0;padding:.5em 0;visibility:hidden}.icons-container .single-icon .btn-copy{background-color:#ff5463;background-color:var(--siteRed);color:#0e1a27;color:var(--textColor);transition:all .2s}.icons-container .single-icon .btn-codepen{background-color:#0e1a27;background-color:var(--textColor);color:#fff;margin:.4em 0 0;transition:all .4s;width:100%}.icons-container .single-icon .btn-codepen svg{fill:#fff;height:20px;margin:0 .4em 0 0;vertical-align:middle;width:20px}.btn-reset{background-color:#fff;border:1px solid;cursor:pointer;font-family:\"Montserrat\";font-weight:500;padding:4px 10px}.btn-reset:hover{background-color:#fbd887;background-color:var(--siteYellow)}.feedback{border:1px solid;border-radius:2px;color:#ff9365;color:var(--siteOrange);display:inline-block;margin:0 auto 2rem;padding:.5rem 1rem;text-decoration:none;width:-webkit-max-content;width:-moz-max-content;width:max-content}.feedback:hover{color:#ff5463;color:var(--siteRed)}.share-twitter{color:#6ebfb5;color:var(--siteBlue);display:inline-block;font-weight:900;position:absolute;top:1em;right:1em;text-decoration:none}.share-twitter svg{fill:#9ee6cf;fill:var(--siteGreen);height:1.5rem;transition:transform .2s;vertical-align:text-bottom;width:1.5rem}.share-twitter:hover{color:#ff9365;color:var(--siteOrange);text-decoration:none}.share-twitter:hover svg{fill:#6ebfb5;fill:var(--siteBlue);transform:translate(1.2em,-2.5em)}.style-bar{align-items:center;background-color:#fff6ec;background-color:var(--bgColor);border:1px solid #222831;border:1px solid var(--borderColor);display:flex;flex-wrap:wrap;justify-content:center;margin:2rem auto;position:-webkit-sticky;position:sticky;top:0;width:100%;z-index:1}@media(max-width:60em){.style-bar{padding-bottom:.5rem}}.style-bar>div{align-items:center;display:flex;margin:1rem}.style-bar>div.show-dash-position{display:none}.style-bar>div.show-dash-position.active{display:flex}.style-bar label{margin-right:.8rem}.style-bar label.checkmark-container{margin-right:0}.style-bar input[type=range]{width:14em;margin:13.8px 0;background-color:transparent;-webkit-appearance:none}.style-bar input[type=range]:focus{outline:none}.style-bar input[type=range]::-webkit-slider-runnable-track{background:#6ebfb5;background:var(--siteBlue);border:.2px solid #222831;border:.2px solid var(--borderColor);border-radius:1.3px;cursor:pointer;width:100%;height:8.4px}.style-bar input[type=range]::-webkit-slider-thumb{margin-top:-14px;width:16px;height:36px;background:#fff;border:1px solid #222831;border:1px solid var(--borderColor);border-radius:3px;cursor:pointer;-webkit-appearance:none}.style-bar input[type=range]:focus::-webkit-slider-runnable-track{background:#9ee6cf;background:var(--siteGreen)}.style-bar input[type=range]::-moz-range-track{background:#6ebfb5;background:var(--siteBlue);border:.2px solid #222831;border:.2px solid var(--borderColor);border-radius:1.3px;width:100%;height:8.4px;cursor:pointer}.style-bar input[type=range]::-moz-range-thumb{width:16px;height:36px;background:#fff;border:1px solid #222831;border:1px solid var(--borderColor);border-radius:3px;cursor:pointer}.style-bar input[type=range]::-ms-track{background:transparent;border-color:transparent;border-width:14.8px 0;color:transparent;width:100%;height:8.4px;cursor:pointer}.style-bar input[type=range]::-ms-fill-lower,.style-bar input[type=range]::-ms-fill-upper{background:#6ebfb5;background:var(--siteBlue);border:.2px solid #222831;border:.2px solid var(--borderColor);border-radius:2.6px}.style-bar input[type=range]::-ms-thumb{width:16px;height:36px;background:#fff;border:1px solid #222831;border:1px solid var(--borderColor);border-radius:3px;cursor:pointer;margin-top:0}.style-bar input[type=range]:focus::-ms-fill-lower{background:#6ebfb5;background:var(--siteBlue)}.style-bar input[type=range]:focus::-ms-fill-upper{background:#9ee6cf;background:var(--siteGreen)}@supports(-ms-ime-align:auto){.style-bar input[type=range]{margin:0}}.style-bar input[type=color]{background-color:#fff;border:1px solid #222831;border:1px solid var(--borderColor);padding:.2rem;width:3rem;height:2rem;-webkit-appearance:none}.style-bar input[type=color]::-webkit-color-swatch-wrapper{padding:.05rem}.style-bar input[type=color]::-webkit-color-swatch{border:0}.checkmark-container{cursor:pointer;align-items:center;display:flex;position:relative}.checkmark-container input[type=checkbox]{cursor:pointer;opacity:0;position:absolute;right:-3px;top:-3px;height:2rem;width:2rem}.checkmark-container input[type=checkbox]:hover+svg .checkmark-bg{fill:#9ee6cf;fill:var(--siteGreen)}.checkmark-container input[type=checkbox]:checked+svg .checkmark-bg{fill:#6ebfb5;fill:var(--siteBlue)}.checkmark-container input[type=checkbox]:checked+svg .checkmark{stroke:#fff}.checkmark-container input[type=checkbox]:focus+svg{outline:1px auto -webkit-focus-ring-color}.checkmark-container svg{margin-left:.8rem;stroke:#222831;stroke:var(--borderColor);width:2rem;height:2rem}.checkmark-container svg *{transition:all .1s linear}@media screen and (-ms-high-contrast:active){.checkmark-container svg rect{stroke:windowText}}@media screen and (-ms-high-contrast:active){.checkmark-container input[type=checkbox]:checked~svg rect{fill:windowText}.checkmark-container input[type=checkbox]:checked~svg polyline{stroke:highlight}}@media(max-width:40em){.mobile-none{display:none}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=c485f330&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-wrapper"},[_vm._ssrNode("<b class=\"top\"></b> <h1><span class=\"home-link\"><a href=\"https://holasvg.com/\">hola svg</a></span>Free Open SVG <span class=\"highlight\">Icons</span></h1> <h2>\n    Learn how to customize them\n    <a rel=\"noopener\" target=\"_blank\" href=\"https://css-tricks.com/how-to-simplify-svg-code-using-basic-shapes/\">here</a>.\n  </h2> <div class=\"style-bar\"><button class=\"btn-reset\">Reset</button> <div><label for=\"inputStrokeRange\">Stroke width:</label> <input id=\"inputStrokeRange\" type=\"range\" min=\"1\" max=\"20\""+(_vm._ssrAttr("value",(_vm.strokeWidthValue)))+"></div> <div><label for=\"inputFillColor\">Fill color:</label> <input id=\"inputFillColor\" type=\"color\""+(_vm._ssrAttr("value",(_vm.fillValue)))+"></div> <div><label for=\"inputStrokeColor\">Stroke color:</label> <input id=\"inputStrokeColor\" type=\"color\""+(_vm._ssrAttr("value",(_vm.strokeColorValue)))+"></div> <div><label for=\"inputLinecapRound\" class=\"checkmark-container\">Round:\n        <input id=\"inputLinecapRound\" type=\"checkbox\""+(_vm._ssrAttr("checked",_vm.lineCapRoundC))+"> <svg width=\"32\" height=\"32\" viewBox=\"0 0 32 32\" aria-hidden=\"true\" focusable=\"false\"><rect x=\"1\" y=\"1\" width=\"30\" height=\"30\" stroke=\"currentColor\" fill=\"none\" stroke-width=\"1\" rx=\"3\" ry=\"3\" class=\"checkmark-bg\"></rect> <polyline points=\"8,17 14,23 25,8\" stroke=\"transparent\" stroke-linejoin=\"round\" stroke-linecap=\"round\" stroke-width=\"4\" fill=\"none\" class=\"checkmark\"></polyline></svg></label></div> <div><label for=\"inputDashTrue\" class=\"checkmark-container\">Stroke dash:\n        <input id=\"inputDashTrue\" type=\"checkbox\""+(_vm._ssrAttr("checked",_vm.isActive))+"> <svg width=\"32\" height=\"32\" viewBox=\"0 0 32 32\" aria-hidden=\"true\" focusable=\"false\"><rect x=\"1\" y=\"1\" width=\"30\" height=\"30\" stroke=\"currentColor\" fill=\"none\" stroke-width=\"1\" rx=\"3\" ry=\"3\" class=\"checkmark-bg\"></rect> <polyline points=\"8,17 14,23 25,8\" stroke=\"transparent\" stroke-linejoin=\"round\" stroke-linecap=\"round\" stroke-width=\"4\" fill=\"none\" class=\"checkmark\"></polyline></svg></label></div> <div"+(_vm._ssrClass("show-dash-position",{ 'active': _vm.isActive }))+"><label for=\"inputDashoffsetffetRange\">Dash position:</label> <input id=\"inputDashoffsetRange\" type=\"range\" min=\"0\" max=\"200\""+(_vm._ssrAttr("value",(_vm.strokeDashoffsetValue)))+"></div></div> <div class=\"icons-container\">"+(_vm._ssrList((_vm.svgIcons),function(icon){return ("<div tabindex=\"0\""+(_vm._ssrAttr("aria-label",icon.title))+(_vm._ssrClass("single-icon",{'active':icon.title === _vm.selectedIcon.title}))+"><svg"+(_vm._ssrAttr("fill",_vm.fillColor))+(_vm._ssrAttr("stroke",_vm.strokeColor))+(_vm._ssrAttr("stroke-width",_vm.strokeWidth))+(_vm._ssrAttr("stroke-dashoffset",_vm.strokeDashoffset))+(_vm._ssrAttr("stroke-dasharray",_vm.strokeDashArray))+(_vm._ssrAttr("stroke-linecap",_vm.lineCap))+(_vm._ssrAttr("stroke-linejoin",_vm.lineJoin))+" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\">"+(_vm._s(icon.editable))+"</svg> <form action=\"https://codepen.io/pen/define\" method=\"POST\" target=\"_blank\"><input type=\"hidden\" name=\"data\""+(_vm._ssrAttr("value",_vm.codepenvalue))+"> <button tabindex=\"0\" type=\"button\" class=\"btn btn-codepen\"><svg viewBox=\"0 0 100 100\"><path d=\"M100 34.2c-.4-2.6-3.3-4-5.3-5.3L84 21.8c-8.5-5.7-17.1-11.4-25.6-17.1-2-1.3-4-2.7-6-4-1.4-1-3.3-1-4.8 0L30.4 12.2 5.2 29C3 30.4.1 31.8 0 34.8c-.1 3.3 0 6.7 0 10v16c0 2.9-.6 6.3 2.1 8.1 6.4 4.4 12.9 8.6 19.4 12.9 8 5.3 16 10.7 24 16 2.2 1.5 4.4 3.1 7.1 1.3 2.3-1.5 4.5-3 6.8-4.5 8.9-5.9 17.8-11.9 26.7-17.8l9.9-6.6c.6-.4 1.3-.8 1.9-1.3 1.4-1 2-2.4 2-4.1V37.3c.1-1.1.2-2.1.1-3.1 0-.1 0 .2 0 0zM54.3 12.3L88 34.8 73 44.9 54.3 32.4V12.3zm-8.6 0v20L27.1 44.8 12 34.8l33.7-22.5zM8.6 42.8L19.3 50 8.6 57.2V42.8zm37.1 44.9L12 65.2l15-10.1 18.6 12.5v20.1zM50 60.2L34.8 50 50 39.8 65.2 50 50 60.2zm4.3 27.5v-20l18.6-12.5 15 10.1-33.6 22.4zm37.1-30.5L80.7 50l10.8-7.2-.1 14.4z\"></path></svg> Create CodePen\n        </button></form> <button type=\"button\" class=\"btn btn-copy\">"+_vm._ssrEscape(_vm._s(_vm.copyText))+"</button> <p><span>"+_vm._ssrEscape(_vm._s(icon.title))+"</span></p></div>")}))+"</div> <a rel=\"noopener\" target=\"_blank\" href=\"https://twitter.com/intent/tweet?text=Free,%20simple,%20and%20customizable%20SVG%20icons!%20https%3A//holasvg.com/icons%0A%40marianabeldi\" class=\"share-twitter\"><svg viewBox=\"30 30 410 410\"><path d=\"M419.6 168.6c-11.7 5.2-24.2 8.7-37.4 10.2 13.4-8.1 23.8-20.8 28.6-36 -12.6 7.5-26.5 12.9-41.3 15.8 -11.9-12.6-28.8-20.6-47.5-20.6 -42 0-72.9 39.2-63.4 79.9 -54.1-2.7-102.1-28.6-134.2-68 -17 29.2-8.8 67.5 20.1 86.9 -10.7-0.3-20.7-3.3-29.5-8.1 -0.7 30.2 20.9 58.4 52.2 64.6 -9.2 2.5-19.2 3.1-29.4 1.1 8.3 25.9 32.3 44.7 60.8 45.2 -27.4 21.4-61.8 31-96.4 27 28.8 18.5 63 29.2 99.8 29.2 120.8 0 189.1-102.1 185-193.6C399.9 193.1 410.9 181.7 419.6 168.6z\"></path></svg> \n    Share <span class=\"mobile-none\"> on Twitter</span></a> <a rel=\"noopener\" href=\"https://docs.google.com/forms/d/e/1FAIpQLSfy9SBgC7xT9vq3RvD9sRxlG7xIcWc-dfN5f1grxnUR7zK6-w/viewform?usp=sf_link\" class=\"btn feedback\">Do you have feedback? 🐣</a> "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=c485f330&
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  async asyncData({
    ...
    const svgIcons = await $content("svg-icons", params.slug).sortBy("order", "asc").fetch();
    return {
      svgIcons
    };
  },
  ...
  head() {
    return {
      ...
      meta: [{
        ...
        property: 'og:url',
        content: "https://holasvg.com/icons/"
      }, {
        property: 'og:title',
        content: "Hola SVG Icons"
      }, {
  ...
  methods: {
    ...
    holacodepen(icon) {
      var codepenhtml = "<svg fill='" + this.fillColor + "' stroke='" + this.strokeColor + "' stroke-width='" + this.strokeWidth + "' stroke-dashoffset='" + this.strokeDashoffset + "' stroke-dasharray='" + this.strokeDashArray + "' stroke-linecap='round' stroke-linejoin='round' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'>" + icon.editable + "</svg>";
      var penArr = {
    ...
    holaclipboard(icon) {
      this.selectedIcon = "<svg fill='" + this.fillColor + "' stroke='" + this.strokeColor + "' stroke-width='" + this.strokeWidth + "' stroke-dashoffset='" + this.strokeDashoffset + "' stroke-dasharray='" + this.strokeDashArray + "' stroke-linecap='round' stroke-linejoin='round' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'>" + icon.editable + "</svg>";
