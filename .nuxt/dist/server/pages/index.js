...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=a924b258&
...
// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=a924b258&
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    holacodepen(icon) {
      ...
      var codepenhtml = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100 fill='" + this.fillColor + "' stroke='" + this.strokeColor + "' stroke-width='" + this.strokeWidth + strokeDashoffsetIs + strokeDashArrayIs + "' stroke-linecap='" + this.lineCap + "' stroke-linejoin='" + this.lineJoin + "'>" + icon.editable + "</svg>";
      var penArr = {
    ...
    holaclipboard(icon) {
      ...
      this.selectedIcon = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100 fill='" + this.fillColor + "' stroke='" + this.strokeColor + "' stroke-width='" + this.strokeWidth + strokeDashoffsetIs + strokeDashArrayIs + "' stroke-linecap='" + this.lineCap + "' stroke-linejoin='" + this.lineJoin + "'>" + icon.editable + "</svg>";
